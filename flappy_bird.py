...
#loading images
bg = pygame.image.load('E:\\5) AI Lab\\Images\\back1.jpg')
ground_img = pygame.image.load('E:\\5) AI Lab\\Images\\ground.png')
button_img = pygame.image.load('E:\\5) AI Lab\\Images\\restart.png')
...
class Bird(pygame.sprite.Sprite):
	def __init__(self, x, y):
		...
		for num in range(1, 4):
			img = pygame.image.load(f'E:\\5) AI Lab\\Images\\bird{num}.png')
...
class Pipe(pygame.sprite.Sprite):
	def __init__(self, x, y, position):
		pygame.sprite.Sprite.__init__(self)
		self.image = pygame.image.load('E:\\5) AI Lab\\Images\\pipe.png')
		self.rect = self.image.get_rect()
